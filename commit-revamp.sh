...
cp safestroke-booking.html safestroke-booking-backup.html
cp safestroke-pricing.html safestroke-pricing-backup.html
cp safestroke-aboutus.html safestroke-aboutus-backup.html
cp safestroke-reviews.html safestroke-reviews-backup.html
cp safestroke-location.html safestroke-location-backup.html
...
if [ -f "safestroke-booking-new.html" ]; then
    ...
    echo "New booking page not found, skipping..."
fi
